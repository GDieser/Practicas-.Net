...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main>
        <section class="row" aria-labelledby="aspnetTitle">
            <h1 id="aspnetTitle">POCHOSO.NET</h1>
            <p class="lead">POCHO.NET es un pagina de indole homosexual que busca recopilar la mayor cantidad de información de nuestro señor.</p>
        ...
        <div class="row">
            ...
            <section class="col-md-4" aria-labelledby="librariesTitle">
                <h2 id="librariesTitle">Travas y más</h2>
                <p>
